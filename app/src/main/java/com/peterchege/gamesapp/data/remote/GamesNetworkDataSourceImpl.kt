...
class GamesNetworkDataSourceImpl @Inject constructor(
    ...
    override suspend fun searchGames(
        ...
        return safeApiCall { api.searchGames(page = page, pageSize = pageSize, searchTerm = searchTerm) }
    }
}